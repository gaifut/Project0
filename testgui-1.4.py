...
#  saving result 
        def save_result():
            ...
            sr1 = save_result_list.append(clicked1.get())
            sr3 = save_result_list.append(options.get())
            sr2 = save_result_list.append(clicked2.get())
            ...
            opened_file2 = filedialog.askopenfilename(initialdir="C:\Python\Project 0.1", title="Select a file")
            print ("Function open read:")
            print (opened_file2)
            self.filename = opened_file2
                    
# get the price from products DB based on the chosen product and adding it to the list save+result_list
            ...
            amend_value_price_per_1_unit = find_price_str.replace("(","").replace(',','').replace(')','')
...
# creating empty lists for product update
            ...
            main_CSV_file_read_to_be_amended = csv.DictReader(open_choose_file_in_GUI)
...
# iterating over each row and append values to empty list
            for col in main_CSV_file_read_to_be_amended:
                ...
                List_for_amendments_CSV_file_Customer_address.append(col['Customer address'])
                List_for_amendments_CSV_file_Product.append(col['Product'])
                List_for_amendments_CSV_file_Quantity.append(col['Quantity'])
                List_for_amendments_CSV_file_Price_Per_1_unit.append(col['Price Per 1 unit'])
                List_for_amendments_CSV_file_Total_cost.append(col['Total cost'])
            ...
            print('Price Per 1 unit', List_for_amendments_CSV_file_Price_Per_1_unit)
            ...
            d = [List_for_amendments_CSV_file_No, List_for_amendments_CSV_file_Customer, 
            List_for_amendments_CSV_file_Supplier, List_for_amendments_CSV_file_Customer_address, List_for_amendments_CSV_file_Product, 
            List_for_amendments_CSV_file_Quantity, List_for_amendments_CSV_file_Price_Per_1_unit, List_for_amendments_CSV_file_Total_cost]

            export_data = zip_longest(*d, fillvalue = '')

            with open ('Updated 3.3 qty and ppu.csv', 'w', encoding="utf8", newline = '') as myfile:
                wr = csv.writer(myfile)
                wr.writerow(("No", "Customer","Supplier","Customer address", "Product", "Quantity", "Price Per 1 unit", "Total cost"))
    ...
    def choose_file(self):
        ...
        opened_file = filedialog.askopenfilename(initialdir="C:\Python\Project 0.1", title="Select a file")
        print ("Function open read:")
        print (opened_file)
...
#  using the generated clean list and adding it as a new column to the original CSV file
        df_dataALL.insert(4,"Customer address updated",updated_customer_address_list, True)
        print(df_dataALL)
...
# Grab all column infomration  
        ...
        for no in range (1, len(data_from_choose_file_in_GUI)):
                list_in_GUI_data_from_choose_file_in_GUI_no.append(data_from_choose_file_in_GUI[no][0])

        var_list_no = StringVar(value=list_in_GUI_data_from_choose_file_in_GUI_no)
        ...
        for customer in range (1, len(data_from_choose_file_in_GUI)):
                list_in_GUI_data_from_choose_file_in_GUI_customer.append(data_from_choose_file_in_GUI[customer][1])
        ...
        for supplier in range (1, len(data_from_choose_file_in_GUI)):
                list_in_GUI_data_from_choose_file_in_GUI_supplier.append(data_from_choose_file_in_GUI[supplier][2])
        ...
        for product in range (1, len(data_from_choose_file_in_GUI)):
            list_in_GUI_data_from_choose_file_in_GUI_product.append(data_from_choose_file_in_GUI[product][4])

        var_list_product = StringVar(value=list_in_GUI_data_from_choose_file_in_GUI_product)
        ...
        for quantity in range (1, len(data_from_choose_file_in_GUI)):
            list_in_GUI_data_from_choose_file_in_GUI_quantity.append(data_from_choose_file_in_GUI[quantity][5])

        var_list_quantity = StringVar(value=list_in_GUI_data_from_choose_file_in_GUI_quantity)
        ...
        for ppu in range (1, len(data_from_choose_file_in_GUI)):
            list_in_GUI_data_from_choose_file_in_GUI_ppu.append(data_from_choose_file_in_GUI[ppu][6])

        var_list_ppu = StringVar(value=list_in_GUI_data_from_choose_file_in_GUI_ppu)
        ...
        var_list_total_cost = StringVar(value=list_in_GUI_data_from_choose_file_in_GUI_total_cost)
